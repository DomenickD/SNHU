...
void SceneManager::LoadSceneTextures()
{
	...
	bool bReturn = false;
	bReturn = CreateGLTexture("../../Utilities/textures/lego_black.jpg", "lego_black");
	bReturn = CreateGLTexture("../../Utilities/textures/lego_brown2.jpg", "lego_brown2");
	bReturn = CreateGLTexture("../../Utilities/textures/lego_white.jpg", "lego_white");
	bReturn = CreateGLTexture("../../Utilities/textures/green_crystal.png", "green");
	bReturn = CreateGLTexture("../../Utilities/textures/lego_orange.png", "lego_orange");
	bReturn = CreateGLTexture("../../Utilities/textures/wood.png", "wood");
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].position", 10.0f, 25.0f, 0.0f);
	...
	// Secondary light source with color
	m_pShaderManager->setVec3Value("lightSources[1].position", -10.0f, 25.0f, 0.0f);
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 0.1f, 0.1f, 0.1f);
	m_pShaderManager->setVec3Value("lightSources[1].diffuseColor", 0.8f, 0.4f, 0.4f); // Reddish diffuse light but idk if it is working
	m_pShaderManager->setVec3Value("lightSources[1].specularColor", 1.0f, 0.5f, 0.5f); // Reddish specular light but idk if it is working
	...
	*/
	m_pShaderManager->setVec3Value("lightSources[0].position", -0.5f, 7.7f, 0.2f);
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.1f, 0.1f, 0.1f);
	m_pShaderManager->setVec3Value("lightSources[0].diffuseColor", 0.4f, 0.4f, 0.4f);
	m_pShaderManager->setVec3Value("lightSources[0].specularColor", 1.0f, 0.4f, 0.4f);
	...
	// Define the second light source with color
	m_pShaderManager->setVec3Value("lightSources[1].position", -15.0f, 12.0f, 3.0f);
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 0.1f, 0.1f, 0.1f);
	m_pShaderManager->setVec3Value("lightSources[1].diffuseColor", 0.4f, 0.4f, 0.4f); // Adding red color to diffuse
	m_pShaderManager->setVec3Value("lightSources[1].specularColor", 0.0f, 0.0f, 0.0f); // Adding red color to specular
	...
	m_pShaderManager->setVec3Value("lightSources[2].position", 3.0f, 12.0f, 10.0f);
	...
	m_pShaderManager->setVec3Value("lightSources[3].position", -3.0f, 12.0f, -10.0f);
	m_pShaderManager->setVec3Value("lightSources[3].ambientColor", 0.01f, 0.01f, 0.01f);
	m_pShaderManager->setVec3Value("lightSources[3].diffuseColor", 0.01f, 0.01f, 0.01f);
	m_pShaderManager->setVec3Value("lightSources[3].specularColor", 1.0f, 0.0f, 0.0f);
...
void SceneManager::RenderScene()
{
	...
	//SetShaderColor(0.9004, 0.768, 0.958, 1);
	SetShaderTexture("lego_black");
	...
	/****************************************************************/
			// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.0f, .3f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.2f, 1.3f, 0.0f);
	...
	//SetShaderColor(.8, .7, .3, 1);
	SetShaderTexture("lego_orange");
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(.8f, 2.3f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.2f, 2.3f, 0.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(3.8f, 3.0f, 1.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.2f, 5.3f, 0.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.5f, 1.1f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 7.7f, 0.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.3f, 0.5f, 0.9f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-0.5f, 7.7f, 0.1f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.6f, 7.7f, 0.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(3.2f, 5.3f, 0.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 7.3f, 0.68f);
